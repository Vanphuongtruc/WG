...
foreach($valueArray as $value){
  if(!empty($_POST[$value])){
    ...
    if($color1 =="green" && $color2 =="green" && $color3 =="green" && $color4 =="green" && $color5 =="green"){
      $_SESSION = $_POST;
...
<!--end-->
            ...
            <tr>
                <td rowspan="2">
                    <div id="table-card "class="card">
                        <a href = #synopsis-area-section onclick="myFunction1()"><img src="img/end game1.jpg" alt="Avatar" style="height: 8cm;" onclick="myFunction1()" > More details</a>
                    </div>
                </td>
        ...
        <div class="col-lg-6">
          <table class="border border-dark">
              <tr>
                  <td rowspan="2">
                      <div id="table-card "class="card">
                        <a href = #synopsis-area-section  onclick="myFunction2()"><img src="img/dumbo.jpg" alt="Avatar" style="height: 8cm;" onclick="myFunction2()"> More details</a>
                      </div>
                  </td>
  ...
  <div id="synopsis-area-section"class="synopsis-area viewport150">
    ...
    <div class="row">
      ...
      <div class="col-md-7 align-items-end">
        <div class="btn-group btn-group-lg" role="group" aria-label="Basic example">
          <button  onclick="discountedPrice1()" class="btn  btn-secondary border rounded" target="_blank" id="demo1">12pm</button>
          <button type="button" class="btn btn-secondary border rounded" onclick="discountedPrice2()" id="demo2" >15pm</button>
          <button type="button" class="btn btn-secondary border rounded" onclick="discountedPrice3()" id="demo3">18pm</button>
          <button type="button" class="btn  btn-secondary border rounded" onclick="discountedPrice4()" id="demo4">21pm</button>
    ...
    <div id="booking-area-section" class="booking-area-section ">
      ...
      <h1><span style="text-align: center; margin-left: 5cm; font-weight: 400;"id="movieName"></span><span style="text-align: center; font-weight: 400;" id="today"></span></h1>
      <div class="row">
              ...
              <h3>First class</h3>
                  ...
                  <div class="well">
                      ...
                      <div class="form-group">
                          ...
                          <h3 class="border"id="totalPrice" name="totalprice" >$0.00</h3>
         ...
         <div class="form-control">
                  ...
                  <div class="date-picker">
                      <label for=""><span style="margin-left: 0.4cm;">Expriry</span></label>
...
<script> 
  document.write("<br>");
  for( key1 in pricesArrayJS)
                        {
                          value1=pricesArrayJS[key1];
                          document.write("<p>"key1 + ':' + value1"</p>")
